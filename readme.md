...
The latest ari-toolkit is available for download. [ari-toolkit v3.9.1](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1.jar) ([sources](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1-sources.jar) | [javadoc](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1-javadoc.jar))
...
#### Direct download
    ...
    Obtain the latest toolkit here: [Toolkit v3.9.1](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1.jar) ([sources](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1-sources.jar) | [javadoc](http://ausregistry.github.com/repo/au/com/ausregistry/arjtk/3.9.1/arjtk-3.9.1-javadoc.jar))
