...
public class HostInfoResponse extends InfoResponse {
	...
	private static final String HOS_STATUS_COUNT_EXPR =
	...
	private static final String HOS_NAME_EXPR = HOS_INF_DATA_EXPR +
		"/host:name/text()";
	private static final String HOS_ADDR_EXPR = HOS_INF_DATA_EXPR +
		"/host:addr[IDX]";
	private static final String HOS_ADDR_COUNT_EXPR = "count(" +
		HOS_INF_DATA_EXPR + "/host:addr)";
