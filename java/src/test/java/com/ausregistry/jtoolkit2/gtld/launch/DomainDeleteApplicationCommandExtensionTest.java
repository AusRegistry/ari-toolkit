...
import com.ausregistry.jtoolkit2.launch.DomainDeleteApplicationCommandExtension;
...
public class DomainDeleteApplicationCommandExtensionTest {
    ...
    public void shouldCreateValidXmlWhenSupplyLaunchExtensionForDelete() throws SAXException {
        ...
        assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\"?><epp xmlns=\"urn:ietf:params:xml:ns:epp-1.0\""
                ...
                + "<delete xmlns=\"urn:rbp:params:xml:ns:application-1.0\"><id>sunrise-application-id</id></delete>"
