...
import com.ausregistry.jtoolkit2.se.fee.DomainCreateFeeResponseExtension;
...
public class DomainCreateApplicationFeeResponseExtensionTest {
    ...
    public void shouldGetFeeExtension() throws Exception {
        ...
        final DomainCreateApplicationFeeResponseExtension feeResponseExtension =
                new DomainCreateApplicationFeeResponseExtension(ResponseExtension.CREATE);
