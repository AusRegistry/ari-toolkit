...
public class DomainCreatePriceV1_1CommandExtensionTest {
    ...
    public void shouldCreateDomainCreateXmlWithPriceAckAndRenewalPrice() throws Exception {
        domainCreatePriceV1_1CommandExtension.setRenewalPrice(BigDecimal.valueOf(9590, 2));
        domainCreateCommand.appendExtension(domainCreatePriceV1_1CommandExtension);
    ...
    public void shouldCreateDomainCreateXmlWithPriceAckAndBothPrices() throws Exception {
        domainCreatePriceV1_1CommandExtension.setPrice(BigDecimal.valueOf(10000, 2));
        domainCreatePriceV1_1CommandExtension.setRenewalPrice(BigDecimal.valueOf(9095, 2));
        domainCreateCommand.appendExtension(domainCreatePriceV1_1CommandExtension);
