...
public class PollResponseTest {
    ...
    public void testGetContactTransferResponse() {
        final ContactTransferResponse ctr = xmlPollResponse(xml2).getContactTransferResponse();
        assertNotNull(ctr);
    ...
    public void testGetDomainTransferResponse() {
        final DomainTransferResponse dtr = xmlPollResponse(xml1).getDomainTransferResponse();
        assertNotNull(dtr);
    ...
    public void shouldGetIdnExtensionFromInfoResponse() {
        final DomainInfoIdnResponseExtension domainInfoIdnResponseExtension = xmlPollResponse(xml4)
    ...
    public void shouldGetSecDnsExtensionFromInfoResponse() {
        final SecDnsDomainInfoResponseExtension secDnsDomainInfoResponseExtension = xmlPollResponse(xml4)
    ...
    public void shouldGetVariantResponseExtension() {
        final DomainVariantResponseExtensionV1_1 variantResponseExtension1_1 = xmlPollResponse(xml4)
    ...
    public void shouldGetRgpResponseExtension() {
        final DomainInfoRgpResponseExtension rgpDomainInfoResponseExtension = xmlPollResponse(xml4)
    ...
    public void shouldGetKvResponseExtension() {
        final DomainInfoKVResponseExtension kvDomainInfoResponseExtension = xmlPollResponse(xml4)
    ...
    public void shouldGetDomainInfoApplicationResponseExtension() {
        final DomainInfoApplicationResponseExtension domainInfoApplicationResponseExtension = xmlPollResponse(xml5)
    ...
    public void testGetResults() {
        final Result[] results1 = xmlPollResponse(xml1).getResults();
        final Result[] results2 = xmlPollResponse(xml2).getResults();
        final Result[] results3 = xmlPollResponse(xml3).getResults();
    ...
    public void testGetCLTRID() {
        assertEquals("ABC-12345", xmlPollResponse(xml1).getCLTRID());
        assertEquals("ABC-12345", xmlPollResponse(xml2).getCLTRID());
        assertEquals("ABC-12345", xmlPollResponse(xml3).getCLTRID());
    }

    @Test
    public void testGetMessageEnqueueDate() {
        assertEquals(EPPDateFormatter.fromXSDateTime("2000-06-08T22:00:00.0Z"), xmlPollResponse(xml1).getMessageEnqueueDate());
        assertEquals(EPPDateFormatter.fromXSDateTime("2000-06-08T22:00:00.0Z"), xmlPollResponse(xml2).getMessageEnqueueDate());
        assertEquals(EPPDateFormatter.fromXSDateTime("2000-06-08T22:00:00.0Z"), xmlPollResponse(xml3).getMessageEnqueueDate());
    }

    @Test
    public void testGetMessage() {
        assertEquals("Transfer requested.", xmlPollResponse(xml1).getMessage());
        assertEquals("Transfer requested.", xmlPollResponse(xml2).getMessage());
        assertEquals("Host updated by TRO.", xmlPollResponse(xml3).getMessage());
    }

    @Test
    public void testGetMessageLanguage() {
        assertEquals("en", xmlPollResponse(xml2).getMessageLanguage());
    }

    @Test
    public void testGetMsgCount() {
        assertEquals("Require 5 messages", 5, xmlPollResponse(xml1).getMsgCount());
        assertEquals("Require 5 messages", 5, xmlPollResponse(xml2).getMsgCount());
        assertEquals("Require 5 messages", 5, xmlPollResponse(xml3).getMsgCount());
    }

    @Test
    public void testGetMsgID() {
        assertEquals("12345", xmlPollResponse(xml1).getMsgID());
        assertEquals("12345", xmlPollResponse(xml2).getMsgID());
        assertEquals("12345", xmlPollResponse(xml3).getMsgID());
    }

    @Test
    public void testGetHostUpdateResponse() {
        final HostInfoResponse hostInfoResponse = xmlPollResponse(xml3).getHostInfoResponse();
