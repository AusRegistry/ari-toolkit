...
public class ContactCreateCommandUnspecExtensionTest {
    ...
    public void shouldGenerateValidXmlWithExtContactYInUnspec() {
        ...
        ContactCreateCommandUnspecExtension ext = new ContactCreateCommandUnspecExtension(true);
        try {
    ...
    public void shouldGenerateValidXmlWithoutExtContactNInUnspec() {
        ...
        ContactCreateCommandUnspecExtension ext = new ContactCreateCommandUnspecExtension(false);
        try {
            cmd.appendExtension(ext);
            String xml = cmd.toXML();
            String expectedXml =
