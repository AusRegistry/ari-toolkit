...
public final class EnumDomainInfoResponse extends DomainInfoResponse {
	...
	private static final String E164_INF_DATA_EXPR =
		"/e:epp/e:response/e:extension/e164epp:infData";
	private static final String NAPTR_COUNT_EXPR = "count(" +
		E164_INF_DATA_EXPR + "/e164epp:naptr)";
	private static final String NAPTR_IND_EXPR =
		exprReplace(E164_INF_DATA_EXPR) + "/e164epp:naptr[IDX]";
